// Generated by dart2js (NullSafetyMode.sound, csp, deferred-serialization, intern-composite-values), the Dart to JavaScript compiler version: 3.0.0-408.0.dev.
...
(function dartProgram() {
  ...
  var A = {JS_CONST: function JS_CONST() {
    ...
    _calcUrlBase() {
      ...
      t1.toString;
      for (t2 = type$.Element._as(document.getElementById("doc-main-container")).getAttribute("data-path").split("/").length, loc = t1, _i = 0; _i < t2; ++_i)
    ...
    Jot: function Jot(t0, t1) {
      ...
      _.urlBase = t0;
      _.initialUrl = t1;
      _.__Jot_search_F = _.__Jot_sidebarManager_F = _.__Jot_navManager_F = $;
    },
    Jot_setup_closure: function Jot_setup_closure(t0) {
      this.$this = t0;
    },
    Jot_setup_closure0: function Jot_setup_closure0(t0) {
      this.$this = t0;
    },
    Jot_setup_closure1: function Jot_setup_closure1(t0, t1) {
      this.$this = t0;
      this.anchor = t1;
    },
    ...
    SearchUI$(urlBase) {
      var t1 = new A.SearchUI(urlBase);
      t1.SearchUI$1(urlBase);
      return t1;
    },
    SearchResultsUI$(glassPane, searchArea) {
      var t1 = new A.SearchResultsUI(glassPane, searchArea);
      t1.SearchResultsUI$2(glassPane, searchArea);
      return t1;
    },
    SearchResultsUI__renderItem(pattern, item) {
      var t3, t4, t5, list,
        t1 = document,
        t2 = t1.createElement("li");
      t2.toString;
      A._ElementCssClassSet__addAll(t2, type$.Iterable_String._as(A._setArrayType(["margin--sm", "padding--sm"], type$.JSArray_String)));
      t2.children.toString;
      t3 = t1.createElement("div");
      t3.children.toString;
      t4 = A.List_List$of(A._renderMatchText(item.get$display(item), item.name, pattern), true, type$.Element);
      t5 = t1.createElement("span");
      t5.toString;
      B.SpanElement_methods.set$text(t5, " " + item.type);
      list = t5.classList;
      list.contains("type").toString;
      list.add("type");
      t4.push(t5);
      A._ChildrenElementList__addAll(t3, type$.Iterable_Element._as(t4));
      t2.appendChild(t3).toString;
      t3 = item.docs;
      if (t3 == null) {
        t1 = t1.createElement("div");
        t1.toString;
        B.DivElement_methods.setInnerHtml$1(t1, "&nbsp;");
        list = t1.classList;
        list.contains("docs").toString;
        list.add("docs");
        t2.appendChild(t1).toString;
      } else {
        t1 = t1.createElement("div");
        t1.toString;
        B.DivElement_methods.set$text(t1, t3);
        list = t1.classList;
        list.contains("docs").toString;
        list.add("docs");
        t2.appendChild(t1).toString;
      ...
      A._EventStreamSubscription$(t2, "mousedown", t1._eval$1("~(1)?")._as(new A.SearchResultsUI__renderItem_closure(item)), false, t1._precomputed1);
      return t2;
    },
    _renderMatchText($async$display, $async$$name, $async$pattern) {
      return A._makeSyncStarIterable(function() {
        var display = $async$display,
          $name = $async$$name,
          pattern = $async$pattern;
        var $async$goto = 0, $async$handler = 1, $async$currentError, t1, t2, t3, list, nameIndex, startsAt, matchAt;
        return function $async$_renderMatchText($async$errorCode, $async$result) {
          ...
          while (true)
            switch ($async$goto) {
              case 0:
                // Function start
                nameIndex = B.JSString_methods.indexOf$1(display, "." + $name);
                startsAt = nameIndex !== -1 ? nameIndex : 0;
                matchAt = B.JSString_methods.indexOf$2(display, pattern, startsAt);
                if (matchAt === -1)
                  matchAt = B.JSString_methods.indexOf$2(display.toLowerCase(), pattern.toLowerCase(), startsAt);
                $async$goto = matchAt === -1 ? 2 : 4;
                break;
              case 2:
                // then
                t1 = document.createElement("span");
                t1.toString;
                B.SpanElement_methods.set$text(t1, display);
                $async$goto = 5;
                return t1;
              case 5:
                // after yield
              ...
              case 4:
                ...
                t2.toString;
                B.SpanElement_methods.set$text(t2, B.JSString_methods.substring$2(display, 0, matchAt));
                $async$goto = 6;
                return t2;
              case 6:
                // after yield
                t2 = t1.createElement("span");
                t2.toString;
                t3 = matchAt + pattern.length;
                B.SpanElement_methods.set$text(t2, B.JSString_methods.substring$2(display, matchAt, t3));
                list = t2.classList;
                list.contains("match").toString;
                list.add("match");
                $async$goto = 7;
                return t2;
              case 7:
                ...
                t1.toString;
                B.SpanElement_methods.set$text(t1, B.JSString_methods.substring$1(display, t3));
                $async$goto = 8;
                return t1;
              case 8:
                // after yield
    ...
    Index$(urlBase) {
      var t1 = new A.Index(new A._AsyncCompleter(new A._Future($.Zone__current, type$._Future_dynamic), type$._AsyncCompleter_dynamic));
      t1.Index$1(urlBase);
      return t1;
    },
    Index__gatherPotentialMatches(pattern, member, matches) {
      var t1, t2, _i;
      if (B.JSString_methods.contains$1(member.name.toLowerCase(), pattern) && member.get$ref() != null)
        B.JSArray_methods.add$1(matches, member);
      if (member.get$children(member).length !== 0)
        for (t1 = member.get$children(member), t2 = t1.length, _i = 0; _i < t1.length; t1.length === t2 || (0, A.throwConcurrentModificationError)(t1), ++_i)
          A.Index__gatherPotentialMatches(pattern, t1[_i], matches);
    },
    IndexMember____parse_tearOff(json) {
      return A.IndexMember_IndexMember$_parse(type$.Map_String_dynamic._as(json));
    },
    IndexMember_IndexMember$_parse(json) {
      var item, t2, _i,
        t1 = J.getInterceptor$asx(json),
        $name = A._asString(t1.$index(json, "n")),
        type = A._asString(t1.$index(json, "t")),
        docs = A._asStringQ(t1.$index(json, "d")),
        ref = A._asStringQ(t1.$index(json, "ref")),
        children = type$.nullable_List_dynamic._as(t1.$index(json, "c"));
      if (ref != null || children != null) {
        t1 = children == null ? B.List_empty0 : J.map$1$1$ax(children, new A.IndexMember_IndexMember$_parse_closure(), type$.IndexMember).toList$0(0);
        item = new A.IndexParent(ref, t1, $name, type, docs);
        for (t2 = t1.length, _i = 0; _i < t2; ++_i)
          t1[_i].parent = item;
        return item;
      } else {
        A._asStringQ(t1.$index(json, "#"));
        return new A.IndexLeaf($name, type, docs);
      }
    },
    SearchResults$(pattern, rawItems) {
      var t1 = new A.SearchResults(pattern);
      t1.SearchResults$2(pattern, rawItems);
      return t1;
    },
    SearchUI: function SearchUI(t0) {
      var _ = this;
      _.urlBase = t0;
      _.__SearchUI_index_F = _.__SearchUI_searchResultsUI_F = _.__SearchUI_searchBox_F = $;
    },
    SearchUI_closure: function SearchUI_closure(t0) {
      this.$this = t0;
    },
    SearchUI_closure0: function SearchUI_closure0(t0) {
      this.$this = t0;
    },
    SearchUI_closure1: function SearchUI_closure1(t0) {
      this.$this = t0;
    },
    SearchUI_closure2: function SearchUI_closure2(t0) {
      this.$this = t0;
    },
    SearchUI__handleInputChanged_closure: function SearchUI__handleInputChanged_closure(t0) {
      this.$this = t0;
    },
    SearchResultsUI: function SearchResultsUI(t0, t1) {
      this.glassPane = t0;
      this.searchArea = t1;
    },
    SearchResultsUI_closure: function SearchResultsUI_closure(t0) {
      this.$this = t0;
    },
    SearchResultsUI_closure0: function SearchResultsUI_closure0() {
    },
    SearchResultsUI_show_closure: function SearchResultsUI_show_closure(t0) {
      this.$this = t0;
    },
    SearchResultsUI_displayResults_closure: function SearchResultsUI_displayResults_closure() {
    },
    SearchResultsUI_displayResults_closure0: function SearchResultsUI_displayResults_closure0(t0) {
      this.results = t0;
    },
    SearchResultsUI__renderItem_closure: function SearchResultsUI__renderItem_closure(t0) {
      this.item = t0;
    },
    SearchResultsUI_hide_closure: function SearchResultsUI_hide_closure(t0) {
      this.$this = t0;
    },
    Index: function Index(t0) {
      this.__Index_members_F = $;
      this._completer = t0;
    },
    Index_closure: function Index_closure(t0) {
      this.$this = t0;
    },
    Index_closure0: function Index_closure0(t0) {
      this.$this = t0;
    },
    IndexMember: function IndexMember() {
    },
    IndexMember_IndexMember$_parse_closure: function IndexMember_IndexMember$_parse_closure() {
    },
    IndexParent: function IndexParent(t0, t1, t2, t3, t4) {
      var _ = this;
      _.ref = t0;
      _.children = t1;
      _.name = t2;
    ...
    IndexLeaf: function IndexLeaf(t0, t1, t2) {
      var _ = this;
      _.name = t0;
      _.type = t1;
      _.docs = t2;
    ...
    SearchResults: function SearchResults(t0) {
      this.pattern = t0;
      this.__SearchResults_items_F = $;
    },
    SearchResults_closure: function SearchResults_closure(t0, t1) {
      this.$this = t0;
      this.patternLower = t1;
    },
    SearchResult: function SearchResult(t0, t1) {
      this.rank = t0;
      this.item = t1;
    },
  ...
  A.SetMixin.prototype = {
    ...
    elementAt$1(_, index) {
      ...
      throw A.wrapException(A.IndexError$withLength(index, elementIndex, this, _s5_));
    }
  };
  ...
  A.Duration.prototype = {
    ...
    toString$0(_) {
      var minutesPadding, seconds, secondsPadding, microsecondsText, t1,
      ...
      microsecondsText = B.JSInt_methods.toString$0(microseconds0 % 1000000);
      t1 = microsecondsText.length - 1;
      if (!(t1 >= 0 && t1 < 6))
        return A.ioore(B.List_43h, t1);
      return "" + (microseconds / 3600000000 | 0) + ":" + minutesPadding + minutes + ":" + secondsPadding + seconds + "." + B.List_43h[t1] + microsecondsText;
    },
    $isComparable: 1
  };
  A.Error.prototype = {
  ...
  A.Window.prototype = {
    ...
    fetch$1(receiver, input) {
      var t1 = receiver.fetch(input, null);
      t1.toString;
  ...
  A._ElementAttributeMap.prototype = {
    containsKey$1(_, key) {
      var t1;
      if (typeof key == "string") {
        t1 = this._element.hasAttribute(key);
        t1.toString;
      } else
        t1 = false;
      return t1;
  ...
  A._ElementCssClassSet.prototype = {
    ...
    toggle$2(_, value, shouldAdd) {
      ...
      if (shouldAdd == null) {
        t1 = t1.classList.toggle(value);
        t1.toString;
      } else
        t1 = A._ElementCssClassSet__toggleOnOff(t1, value, shouldAdd);
      return t1;
    },
  ...
  A.FilteredElementList.prototype = {
    ...
    addAll$1(_, iterable) {
      ...
      for (t1 = iterable.get$iterator(iterable), t2 = this._childNodes._this; t1.moveNext$0();)
        t2.appendChild(t1.get$current(t1)).toString;
    },
    clear$0(_) {
  ...
  A.Jot.prototype = {
    setup$0() {
      ...
      t4 = A.SearchUI$(_this.urlBase);
      _this.__Jot_search_F !== $ && A.throwLateFieldAI("search");
      _this.__Jot_search_F = t4;
      t4 = window;
      t4.toString;
      A._EventStreamSubscription$(t4, "popstate", type$.nullable_void_Function_PopStateEvent._as(new A.Jot_setup_closure0(_this)), false, type$.PopStateEvent);
      A.checkTypeBound(type$.AnchorElement, t1, "T", "querySelectorAll");
      t1 = t2.querySelectorAll("a[data-jot]");
      t1.toString;
      t2 = type$._FrozenElementList_AnchorElement;
      t1 = new A._FrozenElementList(t1, t2);
      t1 = new A.ListIterator(t1, t1.get$length(t1), t2._eval$1("ListIterator<ListMixin.E>"));
      t3 = type$._ElementEventStreamImpl_MouseEvent;
      t4 = t3._eval$1("~(1)?");
      t3 = t3._precomputed1;
      t2 = t2._eval$1("ListMixin.E");
      for (; t1.moveNext$0();) {
        t5 = t1.__internal$_current;
        if (t5 == null)
          t5 = t2._as(t5);
        A._EventStreamSubscription$(t5, "click", t4._as(new A.Jot_setup_closure1(_this, t5)), false, t3);
      }
    ...
    _swapFor$2$updateHistory(url, updateHistory) {
      var $async$goto = 0,
        ...
        $async$returnValue, $async$self = this, t2, response, text, t3, uri, target, t1, $async$temp1;
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              $async$temp1 = t2;
              $async$goto = 3;
              return A._asyncAwait(B.Window_methods.fetch$1(t1, url), $async$_swapFor$2$updateHistory);
            case 3:
              // returning from await.
              response = $async$temp1._as($async$result);
              if (A._asInt(response.status) === 404) {
                A.print("error response: " + A.S(response));
                // goto return
                $async$goto = 1;
                break;
              }
            ...
            case 4:
              ...
              if (updateHistory) {
                ...
                t3 = t3.title;
                t3.toString;
                t1.pushState(new A._StructuredCloneDart2Js([], []).walk$1(url), t3, url);
              }
    ...
    _updateContentLinks$0() {
      ...
      t2 = t1._as(t2.getElementById("doc-main-container"));
      A.checkTypeBound(t1, t1, "T", "querySelectorAll");
      t2 = t2.querySelectorAll("a[href]");
      t2.toString;
      t1 = type$._FrozenElementList_Element;
      t2 = new A._FrozenElementList(t2, t1);
      t2 = new A.ListIterator(t2, t2.get$length(t2), t1._eval$1("ListIterator<ListMixin.E>"));
      t1 = t1._eval$1("ListMixin.E");
      for (; t2.moveNext$0();) {
  ...
  A.SidebarManager.prototype = {
    SidebarManager$2$urlBase(jot, urlBase) {
      ...
      t1 = t1.querySelectorAll("button.menu__caret");
      t1.toString;
    ...
    updateActive$1(uri) {
      ...
      t1 = t1.querySelectorAll("a[data-jot]");
      t1.toString;
      ...
      if (itemAnchor != null) {
        ...
        t1 = t1.querySelectorAll(_s34_);
        t1.toString;
        t3 = type$._FrozenElementList_Element;
        t1 = new A._FrozenElementList(t1, t3);
        t4 = t3._eval$1("ListIterator<ListMixin.E>");
        t1 = new A.ListIterator(t1, t1.get$length(t1), t4);
        t5 = t3._eval$1("ListMixin.E");
        for (; t1.moveNext$0();) {
        ...
        if (parents.length !== 0) {
          ...
          t1 = t1.querySelectorAll(_s34_);
          t1.toString;
          t3 = new A._FrozenElementList(t1, t3);
          t4 = new A.ListIterator(t3, t3.get$length(t3), t4);
          for (; t4.moveNext$0();) {
  ...
  A.NavManager.prototype = {
    updateActive$1(uri) {
      ...
      t3 = type$.Element;
      A.checkTypeBound(t2, t3, "T", _s16_);
      t4 = t1.querySelectorAll(_s11_);
      t4.toString;
      t5 = type$._FrozenElementList_AnchorElement;
      t4 = new A._FrozenElementList(t4, t5);
      t6 = t5._eval$1("ListIterator<ListMixin.E>");
      t4 = new A.ListIterator(t4, t4.get$length(t4), t6);
      t7 = t5._eval$1("ListMixin.E");
      found = false;
      for (; t4.moveNext$0();) {
        t8 = t4.__internal$_current;
        if (t8 == null)
          t8 = t7._as(t8);
      ...
      if (!found) {
        A.checkTypeBound(t2, t3, "T", _s16_);
        t1 = t1.querySelectorAll(_s11_);
        t1.toString;
        t5 = new A._FrozenElementList(t1, t5);
        t6 = new A.ListIterator(t5, t5.get$length(t5), t6);
        for (; t6.moveNext$0();) {
  ...
  A.SearchUI.prototype = {
    SearchUI$1(urlBase) {
      var t2, t3, t4, _this = this,
        t1 = A.Index$(_this.urlBase);
      _this.__SearchUI_index_F !== $ && A.throwLateFieldAI("index");
      _this.__SearchUI_index_F = t1;
      t1 = document;
      t2 = type$.InputElement._as(type$.Element._as(t1.getElementById("search")));
      _this.__SearchUI_searchBox_F !== $ && A.throwLateFieldAI("searchBox");
      _this.__SearchUI_searchBox_F = t2;
      t3 = type$.nullable_Element;
      t4 = t3._as(t1.querySelector("div.search-glass-pane"));
      t4.toString;
      t3 = t3._as(t1.querySelector("div.search-area"));
      t3.toString;
      t3 = A.SearchResultsUI$(t4, t3);
      _this.__SearchUI_searchResultsUI_F !== $ && A.throwLateFieldAI("searchResultsUI");
      _this.__SearchUI_searchResultsUI_F = t3;
      A._EventStreamSubscription$(t1, "keypress", type$.nullable_void_Function_KeyboardEvent._as(new A.SearchUI_closure(_this)), false, type$.KeyboardEvent);
      t1 = type$._ElementEventStreamImpl_KeyboardEvent;
      A._EventStreamSubscription$(t2, "keydown", t1._eval$1("~(1)?")._as(new A.SearchUI_closure0(_this)), false, t1._precomputed1);
      t1 = type$._ElementEventStreamImpl_Event;
      A._EventStreamSubscription$(t2, "input", t1._eval$1("~(1)?")._as(new A.SearchUI_closure1(_this)), false, t1._precomputed1);
      t1 = type$._ElementEventStreamImpl_MouseEvent;
      A._EventStreamSubscription$(t2, "click", t1._eval$1("~(1)?")._as(new A.SearchUI_closure2(_this)), false, t1._precomputed1);
    },
    _activate$0() {
      var t1 = this.__SearchUI_searchBox_F;
      t1 === $ && A.throwLateFieldNI("searchBox");
      t1.focus();
      t1 = t1.value;
      this._handleInputChanged$1(t1 == null ? "" : t1);
    },
    _handleInputChanged$1(text) {
      var t1,
        _s15_ = "searchResultsUI";
      text = B.JSString_methods.trim$0(text);
      t1 = this.__SearchUI_searchResultsUI_F;
      if (text.length === 0) {
        ...
        t1 === $ && A.throwLateFieldNI(_s15_);
        t1.show$0(0);
        t1 = this.__SearchUI_index_F;
        t1 === $ && A.throwLateFieldNI("index");
        t1.search$1(0, text).then$1$1(new A.SearchUI__handleInputChanged_closure(this), type$.Null);
      }
    }
  };
  A.SearchUI_closure.prototype = {
    call$1($event) {
      type$.KeyboardEvent._as($event);
      if ($event.key === "/") {
        $event.preventDefault();
        this.$this._activate$0();
      }
    },
    $signature: 8
  };
  A.SearchUI_closure0.prototype = {
    call$1($event) {
      var t1, t2;
      type$.KeyboardEvent._as($event);
      t1 = $event.key;
      if (t1 === "Escape") {
        t1 = this.$this;
        t2 = t1.__SearchUI_searchBox_F;
        t2 === $ && A.throwLateFieldNI("searchBox");
        t2.blur();
        t1 = t1.__SearchUI_searchResultsUI_F;
        t1 === $ && A.throwLateFieldNI("searchResultsUI");
        t1.hide$0();
      } else if (t1 === "Enter")
        $event.preventDefault();
    },
  ...
  A.SearchUI_closure1.prototype = {
    call$1($event) {
      var t1 = this.$this,
        t2 = t1.__SearchUI_searchBox_F;
      t2 === $ && A.throwLateFieldNI("searchBox");
      t2 = t2.value;
      t1._handleInputChanged$1(t2 == null ? "" : t2);
    },
    $signature: 5
  };
  A.SearchUI_closure2.prototype = {
    call$1($event) {
      type$.MouseEvent._as($event);
      this.$this._activate$0();
    },
  ...
  A.SearchUI__handleInputChanged_closure.prototype = {
    call$1(results) {
      var t1;
      type$.SearchResults._as(results);
      t1 = this.$this.__SearchUI_searchResultsUI_F;
      t1 === $ && A.throwLateFieldNI("searchResultsUI");
      t1.displayResults$1(results);
    },
    $signature: 34
  };
  A.SearchResultsUI.prototype = {
    SearchResultsUI$2(glassPane, searchArea) {
      var t1 = J.get$onMouseDown$x(this.glassPane),
        t2 = t1.$ti;
      A._EventStreamSubscription$(t1._target, t1._eventType, t2._eval$1("~(1)?")._as(new A.SearchResultsUI_closure(this)), false, t2._precomputed1);
      t2 = J.get$onMouseDown$x(this.searchArea);
      t1 = t2.$ti;
      A._EventStreamSubscription$(t2._target, t2._eventType, t1._eval$1("~(1)?")._as(new A.SearchResultsUI_closure0()), false, t1._precomputed1);
    },
    show$0(_) {
      var t1 = this.glassPane.style,
        t2 = t1.display;
      t2.toString;
      if (t2 === "none") {
        t1.display = "block";
        A.Timer_Timer(B.Duration_0, new A.SearchResultsUI_show_closure(this));
      }
    },
    displayResults$1(results) {
      var t2, t3, items, total, t4, _s5_ = "items",
        t1 = results.__SearchResults_items_F;
      t1 === $ && A.throwLateFieldNI(_s5_);
      t2 = A._arrayInstanceType(t1);
      t3 = t2._eval$1("MappedListIterable<1,IndexMember>");
      items = A.List_List$of(new A.MappedListIterable(t1, t2._eval$1("IndexMember(1)")._as(new A.SearchResultsUI_displayResults_closure()), t3), true, t3._eval$1("ListIterable.E"));
      total = items.length;
      if (total > 200)
        items = A.SubListIterable$(items, 0, A.checkNotNullable(200, "count", type$.int), A._arrayInstanceType(items)._precomputed1).toList$0(0);
      t1 = this.searchArea;
      t2 = t1.querySelector("ul");
      t2.toString;
      t3 = J.getInterceptor$x(t2);
      t3.get$children(t2).clear$0(0);
      t4 = A._arrayInstanceType(items);
      t3.get$children(t2).addAll$1(0, new A.MappedListIterable(items, t4._eval$1("Element(1)")._as(new A.SearchResultsUI_displayResults_closure0(results)), t4._eval$1("MappedListIterable<1,Element>")));
      t1 = t1.querySelector("div.search-footer");
      t1.toString;
      t2 = items.length;
      t3 = "" + t2;
      if (total !== t2) {
        t2 = total === 1 ? "item" : _s5_;
        J.set$text$x(t1, "showing " + t3 + " of " + t3 + " " + t2);
      } else {
        t2 = total === 1 ? "item" : _s5_;
        J.set$text$x(t1, t3 + " " + t2);
      }
    },
    hide$0() {
      var t1 = this.glassPane.style,
      ...
      t2.toString;
      if (t2 !== "none") {
        B.CssStyleDeclaration_methods._setPropertyHelper$3(t1, B.CssStyleDeclaration_methods._browserPropertyName$1(t1, "opacity"), "0.0", "");
        A.Timer_Timer(B.Duration_200000, new A.SearchResultsUI_hide_closure(this));
      }
    }
  };
  A.SearchResultsUI_closure.prototype = {
    call$1(_) {
  ...
  A.SearchResultsUI_closure0.prototype = {
    call$1($event) {
      type$.MouseEvent._as($event).stopPropagation();
    },
    $signature: 1
  };
  A.SearchResultsUI_show_closure.prototype = {
    call$0() {
      var t1 = this.$this.glassPane.style;
      t1.toString;
      B.CssStyleDeclaration_methods._setPropertyHelper$3(t1, B.CssStyleDeclaration_methods._browserPropertyName$1(t1, "opacity"), "1.0", "");
      return "1.0";
    },
    $signature: 0
  };
  A.SearchResultsUI_displayResults_closure.prototype = {
    call$1(result) {
      return type$.SearchResult._as(result).item;
    },
    $signature: 35
  };
  A.SearchResultsUI_displayResults_closure0.prototype = {
    call$1(c) {
      return A.SearchResultsUI__renderItem(this.results.pattern, type$.IndexMember._as(c));
    },
    $signature: 36
  };
  A.SearchResultsUI__renderItem_closure.prototype = {
    call$1($event) {
      var t1, t2;
      type$.MouseEvent._as($event).stopPropagation();
      t1 = this.item;
      A.print("[" + t1.toString$0(0) + "]");
      t2 = window;
      t2.toString;
      B.Window_methods.alert$1(t2, t1.type + " " + t1.name);
    },
    $signature: 1
  };
  A.SearchResultsUI_hide_closure.prototype = {
    call$0() {
      var t1 = this.$this.glassPane.style;
      t1.display = "none";
      return "none";
  ...
  A.Index.prototype = {
    Index$1(urlBase) {
      this._init$1(urlBase).then$1$2$onError(new A.Index_closure(this), new A.Index_closure0(this), type$.Null);
    },
    _init$1(urlBase) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.List_IndexMember),
        $async$returnValue, t2, response, jsonIndex, t1, $async$temp1, $async$temp2, $async$temp3;
      var $async$_init$1 = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1)
          return A._asyncRethrow($async$result, $async$completer);
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              $async$temp1 = t2;
              $async$goto = 3;
              return A._asyncAwait(B.Window_methods.fetch$1(t1, urlBase + "resources/index.json"), $async$_init$1);
            case 3:
              // returning from await.
              response = $async$temp1._as($async$result);
              if (A._asInt(response.status) === 404) {
                A.print("error response: " + A.S(response));
                $async$returnValue = A._setArrayType([], type$.JSArray_IndexMember);
                // goto return
                $async$goto = 1;
                break;
              }
              ...
              $async$goto = 4;
              return A._asyncAwait(A.promiseToFuture(t2._as(response.text()), type$.String), $async$_init$1);
            case 4:
              // returning from await.
              ...
              t1 = jsonIndex.$ti;
              t2 = t1._eval$1("MappedListIterable<ListMixin.E,IndexMember>");
              $async$returnValue = A.List_List$of(new A.MappedListIterable(jsonIndex, t1._eval$1("IndexMember(ListMixin.E)")._as(A.search_IndexMember____parse_tearOff$closure()), t2), true, t2._eval$1("ListIterable.E"));
              // goto return
              $async$goto = 1;
              break;
            case 1:
      ...
      return A._asyncStartSync($async$_init$1, $async$completer);
    },
    search$1(_, pattern) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.SearchResults),
        $async$returnValue, $async$self = this, lower, potential, t1;
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              // Function start
              $async$goto = 3;
              return A._asyncAwait($async$self._completer.future, $async$search$1);
            case 3:
              // returning from await.
              lower = pattern.toLowerCase();
              potential = A._setArrayType([], type$.JSArray_IndexMember);
              t1 = $async$self.__Index_members_F;
              t1 === $ && A.throwLateFieldNI("members");
              t1 = J.get$iterator$ax(t1);
              for (; t1.moveNext$0();)
                A.Index__gatherPotentialMatches(lower, t1.get$current(t1), potential);
              $async$returnValue = A.SearchResults$(pattern, potential);
              // goto return
              $async$goto = 1;
              break;
            case 1:
    ...
    set$__Index_members_F(__Index_members_F) {
      this.__Index_members_F = type$.List_IndexMember._as(__Index_members_F);
    }
  };
  A.Index_closure.prototype = {
    call$1(result) {
      var t1;
      type$.List_IndexMember._as(result);
      t1 = this.$this;
      t1.__Index_members_F !== $ && A.throwLateFieldAI("members");
      t1.set$__Index_members_F(result);
      t1._completer.complete$0(0);
    },
    $signature: 37
  };
  A.Index_closure0.prototype = {
    call$2(error, stackTrace) {
      var t1 = this.$this,
        t2 = type$.List_IndexMember._as(A._setArrayType([], type$.JSArray_IndexMember));
      t1.__Index_members_F !== $ && A.throwLateFieldAI("members");
      t1.set$__Index_members_F(t2);
      A.print("error reading index: " + A.S(error));
      t1._completer.complete$0(0);
    },
    $signature: 9
  };
  A.IndexMember.prototype = {
    get$display(_) {
      var t2, _this = this,
        t1 = _this.type;
      if (t1 === "class")
        ...
        return _this.name + "()";
      else if (t1 === "method" || t1 === "constructor")
        return _this.get$_maybeParent() + _this.name + "()";
      else {
        t2 = _this.name;
        if (t1 === "field")
          return _this.get$_maybeParent() + t2;
        else
          return t2;
      }
    },
    ...
    get$_maybeParent() {
      var t1 = this.parent;
      return t1 == null ? "" : t1.name + ".";
    },
    toString$0(_) {
      return this.type + " " + this.name;
    }
  };
  A.IndexMember_IndexMember$_parse_closure.prototype = {
    call$1(c) {
      return A.IndexMember_IndexMember$_parse(type$.Map_String_dynamic._as(c));
    },
    $signature: 38
  };
  A.IndexParent.prototype = {
    get$ref() {
      return this.ref;
    },
    get$children(receiver) {
  ...
  A.IndexLeaf.prototype = {
    get$ref() {
      var t1 = this.parent;
      return t1 == null ? null : t1.ref;
    },
    get$children(_) {
      return B.List_empty0;
    }
  };
  A.SearchResults.prototype = {
    SearchResults$2(pattern, rawItems) {
      var _this = this,
        t1 = A._arrayInstanceType(rawItems),
        t2 = t1._eval$1("MappedListIterable<1,SearchResult>");
      t2 = A.List_List$of(new A.MappedListIterable(rawItems, t1._eval$1("SearchResult(1)")._as(new A.SearchResults_closure(_this, _this.pattern.toLowerCase())), t2), true, t2._eval$1("ListIterable.E"));
      B.JSArray_methods.sort$0(t2);
      type$.List_SearchResult._as(t2);
      _this.__SearchResults_items_F !== $ && A.throwLateFieldAI("items");
      _this.set$__SearchResults_items_F(t2);
    },
    set$__SearchResults_items_F(__SearchResults_items_F) {
      this.__SearchResults_items_F = type$.List_SearchResult._as(__SearchResults_items_F);
    }
  };
  A.SearchResults_closure.prototype = {
    call$1(item) {
      var t1, $name, rank, $package;
      type$.IndexMember._as(item);
      t1 = this.$this.pattern;
      $name = item.name;
      if ($name === t1)
        rank = 400;
      else if (B.JSString_methods.startsWith$1($name, t1))
        rank = 300;
      else
        rank = B.JSString_methods.startsWith$1($name.toLowerCase(), this.patternLower) ? 200 : 100;
      t1 = item.type;
      if (t1 === "class" || t1 === "extension")
        rank += 10;
      $package = item.get$packageName();
      if (J.containsKey$1$x(B.Set_uTEps._collection$_map, $package))
        rank += 5;
      else if (J.containsKey$1$x(B.Set_FMav3._collection$_map, $package))
        rank -= 5;
      return new A.SearchResult(rank, item);
    },
    $signature: 39
  };
  A.SearchResult.prototype = {
    compareTo$1(_, other) {
      var diff, t1, t2;
      type$.SearchResult._as(other);
      diff = other.rank - this.rank;
      if (diff !== 0)
        return diff;
      t1 = this.item;
      t2 = other.item;
      diff = B.JSString_methods.compareTo$1(t1.name, t2.name);
      if (diff !== 0)
        return diff;
      return B.JSString_methods.compareTo$1(t1.get$display(t1), t2.get$display(t2));
    },
    toString$0(_) {
      return "[" + this.rank + " " + this.item.toString$0(0) + "]";
    },
    $isComparable: 1
  };
  A.Path.prototype = {
    ...
    relative$2$from(path, from) {
      ...
      for (t1 = froms.length, _i = 0; _i < froms.length; froms.length === t1 || (0, A.throwConcurrentModificationError)(froms), ++_i)
        B.JSArray_methods.insert$2(paths, 0, "..");
  ...
  (function installTearOffs() {
    ...
    _static_1(A, "search_IndexMember____parse_tearOff$closure", "IndexMember____parse_tearOff", 28);
  })();
  (function inheritance() {
    ...
    _inheritMany(A.Object, [A.JS_CONST, J.Interceptor, J.ArrayIterator, A.Iterable, A.CastIterator, A.Error, A.SentinelValue, A.ListIterator, A.MappedIterator, A.WhereIterator, A.FixedLengthListMixin, A.ConstantMap, A.TypeErrorDecoder, A.NullThrownFromJavaScriptException, A.ExceptionAndStackTrace, A._StackTrace, A.Closure, A.MapMixin, A.LinkedHashMapCell, A.LinkedHashMapKeyIterator, A.JSSyntaxRegExp, A.Rti, A._FunctionParameters, A._Type, A._TimerImpl, A._AsyncAwaitCompleter, A._IterationMarker, A._SyncStarIterator, A.AsyncError, A._Completer, A._FutureListener, A._Future, A._AsyncCallbackEntry, A.Stream, A._StreamIterator, A._Zone, A.__SetBase_Object_SetMixin, A._LinkedHashSetCell, A._LinkedHashSetIterator, A._ListBase_Object_ListMixin, A.ListMixin, A.SetMixin, A._SetBase_Object_SetMixin, A._UnmodifiableSetMixin, A.Codec, A.Converter, A.DateTime, A.Duration, A.OutOfMemoryError, A.StackOverflowError, A._Exception, A.FormatException, A.Null, A._StringStackTrace, A.StringBuffer, A._Uri, A.UriData, A._SimpleUri, A.CssStyleDeclarationBase, A.EventStreamProvider, A._EventStreamSubscription, A._Html5NodeValidator, A.ImmutableListMixin, A.NodeValidatorBuilder, A._SimpleNodeValidator, A._SvgNodeValidator, A.FixedSizeListIterator, A._TrustedHtmlTreeSanitizer, A._SameOriginUriPolicy, A._ValidatingTreeSanitizer, A._StructuredClone, A._AcceptStructuredClone, A.NullRejectionException, A.Jot, A.SidebarManager, A.NavManager, A.SearchUI, A.SearchResultsUI, A.Index, A.IndexMember, A.SearchResults, A.SearchResult, A.Path]);
    ...
    _inheritMany(A.Iterable, [A._CastIterableBase, A.EfficientLengthIterable, A.MappedIterable, A.WhereIterable, A._ConstantMapKeyIterable, A.IterableBase]);
    ...
    _inheritMany(A.Closure, [A.Closure0Args, A.Closure2Args, A.TearOffClosure, A.initHooks_closure, A.initHooks_closure1, A._AsyncRun__initializeScheduleImmediate_internalCallback, A._AsyncRun__initializeScheduleImmediate_closure, A._awaitOnObject_closure, A._Future__chainForeignFuture_closure, A._Future__propagateToListeners_handleWhenCompleteCallback_closure, A.Stream_length_closure, A._RootZone_bindUnaryCallbackGuarded_closure, A._createTables_setChars, A._createTables_setRange, A.Element_Element$html_closure, A._EventStreamSubscription_closure, A.NodeValidatorBuilder_allowsElement_closure, A.NodeValidatorBuilder_allowsAttribute_closure, A._SimpleNodeValidator_closure, A._SimpleNodeValidator_closure0, A._TemplatingNodeValidator_closure, A.CssClassSetImpl_add_closure, A.FilteredElementList__iterable_closure, A.FilteredElementList__iterable_closure0, A.promiseToFuture_closure, A.promiseToFuture_closure0, A.Jot_setup_closure, A.Jot_setup_closure0, A.Jot_setup_closure1, A.Jot__updateContentLinks_closure, A.SidebarManager_closure, A.SearchUI_closure, A.SearchUI_closure0, A.SearchUI_closure1, A.SearchUI_closure2, A.SearchUI__handleInputChanged_closure, A.SearchResultsUI_closure, A.SearchResultsUI_closure0, A.SearchResultsUI_displayResults_closure, A.SearchResultsUI_displayResults_closure0, A.SearchResultsUI__renderItem_closure, A.Index_closure, A.IndexMember_IndexMember$_parse_closure, A.SearchResults_closure]);
    ...
    _inheritMany(A.Converter, [A.Base64Encoder, A.JsonDecoder]);
    ...
    _inheritMany(A.HtmlElement, [A.AnchorElement, A.AreaElement, A.BaseElement, A.BodyElement, A.DivElement, A.FormElement, A.InputElement, A.LIElement, A.LinkElement, A.SelectElement, A.SpanElement, A.TableElement, A.TableRowElement, A.TableSectionElement, A.TemplateElement]);
    ...
    _inheritMany(A.IndexMember, [A.IndexParent, A.IndexLeaf]);
  ...
  var init = {
    ...
    mangledNames: {},
    types: ["~()", "~(MouseEvent)", "~(String,@)", "~(~())", "~(@)", "~(Event)", "bool(Element,String,String,_Html5NodeValidator)", "Null()", "~(KeyboardEvent)", "Null(@,@)", "bool(String)", "bool(NodeValidator)", "Null(@)", "bool(Node)", "~(Uint8List,String,int)", "int(int,int)", "Uint8List(@,@)", "@(@)", "~(String,int)", "~(Object?,Object?)", "~(String,String)", "~(String,int?)", "_Future<@>(@)", "Null(Object,StackTrace)", "String(String)", "~(Node,Node?)", "~(@,@)", "~(int,@)", "IndexMember(Map<String,@>)", "bool(Set<String>)", "Element(Node)", "Null(~())", "~(PopStateEvent)", "Null(@,StackTrace)", "Null(SearchResults)", "IndexMember(SearchResult)", "LIElement(IndexMember)", "Null(List<IndexMember>)", "IndexMember(@)", "SearchResult(IndexMember)", "int(@,@)", "@(String)", "@(@,String)", "@(@,@)"],
    interceptorsByTag: null,
    leafTags: null,
    arrayRti: Symbol("$ti")
  };
  A._Universe_addRules(init.typeUniverse, JSON.parse('{"PlainJavaScriptObject":"LegacyJavaScriptObject","UnknownJavaScriptObject":"LegacyJavaScriptObject","JavaScriptFunction":"LegacyJavaScriptObject","KeyframeEffect":"JavaScriptObject","KeyframeEffectReadOnly":"JavaScriptObject","AnimationEffectReadOnly":"JavaScriptObject","AbortPaymentEvent":"Event","ExtendableEvent":"Event","AudioContext":"BaseAudioContext","AbsoluteOrientationSensor":"EventTarget","OrientationSensor":"EventTarget","Sensor":"EventTarget","AElement":"SvgElement","GraphicsElement":"SvgElement","AudioElement":"HtmlElement","MediaElement":"HtmlElement","ShadowRoot":"Node","DocumentFragment":"Node","XmlDocument":"Document","PointerEvent":"MouseEvent","VttCue":"TextTrackCue","CompositionEvent":"UIEvent","CDataSection":"CharacterData","Text":"CharacterData","MathMLElement":"Element","HtmlFormControlsCollection":"HtmlCollection","CssCharsetRule":"CssRule","CssMatrixComponent":"CssTransformComponent","CssStyleSheet":"StyleSheet","CssurlImageValue":"CssStyleValue","CssImageValue":"CssStyleValue","CssResourceValue":"CssStyleValue","JavaScriptObject":{"JSObject":[]},"JSBool":{"bool":[],"TrustedGetRuntimeType":[]},"JSNull":{"Null":[],"TrustedGetRuntimeType":[]},"LegacyJavaScriptObject":{"JavaScriptObject":[],"JSObject":[]},"JSArray":{"List":["1"],"JavaScriptObject":[],"EfficientLengthIterable":["1"],"JSObject":[],"Iterable":["1"]},"JSUnmodifiableArray":{"JSArray":["1"],"List":["1"],"JavaScriptObject":[],"EfficientLengthIterable":["1"],"JSObject":[],"Iterable":["1"]},"ArrayIterator":{"Iterator":["1"]},"JSNumber":{"double":[],"num":[],"Comparable":["num"]},"JSInt":{"double":[],"int":[],"num":[],"Comparable":["num"],"TrustedGetRuntimeType":[]},"JSNumNotInt":{"double":[],"num":[],"Comparable":["num"],"TrustedGetRuntimeType":[]},"JSString":{"String":[],"Comparable":["String"],"Pattern":[],"TrustedGetRuntimeType":[]},"_CastIterableBase":{"Iterable":["2"]},"CastIterator":{"Iterator":["2"]},"CastIterable":{"_CastIterableBase":["1","2"],"Iterable":["2"],"Iterable.E":"2"},"_EfficientLengthCastIterable":{"CastIterable":["1","2"],"_CastIterableBase":["1","2"],"EfficientLengthIterable":["2"],"Iterable":["2"],"Iterable.E":"2"},"_CastListBase":{"ListMixin":["2"],"List":["2"],"_CastIterableBase":["1","2"],"EfficientLengthIterable":["2"],"Iterable":["2"]},"CastList":{"_CastListBase":["1","2"],"ListMixin":["2"],"List":["2"],"_CastIterableBase":["1","2"],"EfficientLengthIterable":["2"],"Iterable":["2"],"ListMixin.E":"2","Iterable.E":"2"},"LateError":{"Error":[]},"EfficientLengthIterable":{"Iterable":["1"]},"ListIterable":{"EfficientLengthIterable":["1"],"Iterable":["1"]},"SubListIterable":{"ListIterable":["1"],"EfficientLengthIterable":["1"],"Iterable":["1"],"ListIterable.E":"1","Iterable.E":"1"},"ListIterator":{"Iterator":["1"]},"MappedIterable":{"Iterable":["2"],"Iterable.E":"2"},"EfficientLengthMappedIterable":{"MappedIterable":["1","2"],"EfficientLengthIterable":["2"],"Iterable":["2"],"Iterable.E":"2"},"MappedIterator":{"Iterator":["2"]},"MappedListIterable":{"ListIterable":["2"],"EfficientLengthIterable":["2"],"Iterable":["2"],"ListIterable.E":"2","Iterable.E":"2"},"WhereIterable":{"Iterable":["1"],"Iterable.E":"1"},"WhereIterator":{"Iterator":["1"]},"ConstantMap":{"Map":["1","2"]},"ConstantStringMap":{"ConstantMap":["1","2"],"Map":["1","2"]},"_ConstantMapKeyIterable":{"Iterable":["1"],"Iterable.E":"1"},"NullError":{"TypeError":[],"Error":[]},"JsNoSuchMethodError":{"Error":[]},"UnknownJsTypeError":{"Error":[]},"_StackTrace":{"StackTrace":[]},"Closure":{"Function":[]},"Closure0Args":{"Function":[]},"Closure2Args":{"Function":[]},"TearOffClosure":{"Function":[]},"StaticClosure":{"Function":[]},"BoundClosure":{"Function":[]},"_CyclicInitializationError":{"Error":[]},"RuntimeError":{"Error":[]},"_AssertionError":{"Error":[]},"JsLinkedHashMap":{"MapMixin":["1","2"],"Map":["1","2"],"MapMixin.K":"1","MapMixin.V":"2"},"LinkedHashMapKeyIterable":{"EfficientLengthIterable":["1"],"Iterable":["1"],"Iterable.E":"1"},"LinkedHashMapKeyIterator":{"Iterator":["1"]},"JSSyntaxRegExp":{"RegExp":[],"Pattern":[]},"NativeByteBuffer":{"JavaScriptObject":[],"JSObject":[],"TrustedGetRuntimeType":[]},"NativeTypedData":{"JavaScriptObject":[],"JSObject":[]},"NativeByteData":{"NativeTypedData":[],"JavaScriptObject":[],"JSObject":[],"TrustedGetRuntimeType":[]},"NativeTypedArray":{"NativeTypedData":[],"JavaScriptIndexingBehavior":["1"],"JavaScriptObject":[],"JSObject":[]},"NativeTypedArrayOfDouble":{"ListMixin":["double"],"NativeTypedData":[],"JavaScriptIndexingBehavior":["double"],"List":["double"],"JavaScriptObject":[],"EfficientLengthIterable":["double"],"JSObject":[],"Iterable":["double"],"FixedLengthListMixin":["double"]},"NativeTypedArrayOfInt":{"ListMixin":["int"],"NativeTypedData":[],"JavaScriptIndexingBehavior":["int"],"List":["int"],"JavaScriptObject":[],"EfficientLengthIterable":["int"],"JSObject":[],"Iterable":["int"],"FixedLengthListMixin":["int"]},"NativeFloat32List":{"ListMixin":["double"],"NativeTypedData":[],"JavaScriptIndexingBehavior":["double"],"List":["double"],"JavaScriptObject":[],"EfficientLengthIterable":["double"],"JSObject":[],"Iterable":["double"],"FixedLengthListMixin":["double"],"TrustedGetRuntimeType":[],"ListMixin.E":"double"},"NativeFloat64List":{"ListMixin":["double"],"NativeTypedData":[],"JavaScriptIndexingBehavior":["double"],"List":["double"],"JavaScriptObject":[],"EfficientLengthIterable":["double"],"JSObject":[],"Iterable":["double"],"FixedLengthListMixin":["double"],"TrustedGetRuntimeType":[],"ListMixin.E":"double"},"NativeInt16List":{"ListMixin":["int"],"NativeTypedData":[],"JavaScriptIndexingBehavior":["int"],"List":["int"],"JavaScriptObject":[],"EfficientLengthIterable":["int"],"JSObject":[],"Iterable":["int"],"FixedLengthListMixin":["int"],"TrustedGetRuntimeType":[],"ListMixin.E":"int"},"NativeInt32List":{"ListMixin":["int"],"NativeTypedData":[],"JavaScriptIndexingBehavior":["int"],"List":["int"],"JavaScriptObject":[],"EfficientLengthIterable":["int"],"JSObject":[],"Iterable":["int"],"FixedLengthListMixin":["int"],"TrustedGetRuntimeType":[],"ListMixin.E":"int"},"NativeInt8List":{"ListMixin":["int"],"NativeTypedData":[],"JavaScriptIndexingBehavior":["int"],"List":["int"],"JavaScriptObject":[],"EfficientLengthIterable":["int"],"JSObject":[],"Iterable":["int"],"FixedLengthListMixin":["int"],"TrustedGetRuntimeType":[],"ListMixin.E":"int"},"NativeUint16List":{"ListMixin":["int"],"NativeTypedData":[],"JavaScriptIndexingBehavior":["int"],"List":["int"],"JavaScriptObject":[],"EfficientLengthIterable":["int"],"JSObject":[],"Iterable":["int"],"FixedLengthListMixin":["int"],"TrustedGetRuntimeType":[],"ListMixin.E":"int"},"NativeUint32List":{"ListMixin":["int"],"NativeTypedData":[],"JavaScriptIndexingBehavior":["int"],"List":["int"],"JavaScriptObject":[],"EfficientLengthIterable":["int"],"JSObject":[],"Iterable":["int"],"FixedLengthListMixin":["int"],"TrustedGetRuntimeType":[],"ListMixin.E":"int"},"NativeUint8ClampedList":{"ListMixin":["int"],"NativeTypedData":[],"JavaScriptIndexingBehavior":["int"],"List":["int"],"JavaScriptObject":[],"EfficientLengthIterable":["int"],"JSObject":[],"Iterable":["int"],"FixedLengthListMixin":["int"],"TrustedGetRuntimeType":[],"ListMixin.E":"int"},"NativeUint8List":{"ListMixin":["int"],"Uint8List":[],"NativeTypedData":[],"JavaScriptIndexingBehavior":["int"],"List":["int"],"JavaScriptObject":[],"EfficientLengthIterable":["int"],"JSObject":[],"Iterable":["int"],"FixedLengthListMixin":["int"],"TrustedGetRuntimeType":[],"ListMixin.E":"int"},"_Error":{"Error":[]},"_TypeError":{"TypeError":[],"Error":[]},"_Future":{"Future":["1"]},"_AsyncAwaitCompleter":{"Completer":["1"]},"_SyncStarIterator":{"Iterator":["1"]},"_SyncStarIterable":{"Iterable":["1"],"Iterable.E":"1"},"AsyncError":{"Error":[]},"_Completer":{"Completer":["1"]},"_AsyncCompleter":{"_Completer":["1"],"Completer":["1"]},"_Zone":{"Zone":[]},"_RootZone":{"_Zone":[],"Zone":[]},"_LinkedHashSet":{"SetMixin":["1"],"Set":["1"],"EfficientLengthIterable":["1"],"Iterable":["1"],"SetMixin.E":"1"},"_LinkedHashSetIterator":{"Iterator":["1"]},"IterableBase":{"Iterable":["1"]},"ListBase":{"ListMixin":["1"],"List":["1"],"EfficientLengthIterable":["1"],"Iterable":["1"]},"MapBase":{"MapMixin":["1","2"],"Map":["1","2"]},"MapMixin":{"Map":["1","2"]},"SetBase":{"SetMixin":["1"],"Set":["1"],"EfficientLengthIterable":["1"],"Iterable":["1"]},"_SetBase":{"SetMixin":["1"],"Set":["1"],"EfficientLengthIterable":["1"],"Iterable":["1"]},"_UnmodifiableSet":{"SetMixin":["1"],"_UnmodifiableSetMixin":["1"],"Set":["1"],"EfficientLengthIterable":["1"],"Iterable":["1"],"SetMixin.E":"1"},"_JsonMap":{"MapMixin":["String","@"],"Map":["String","@"],"MapMixin.K":"String","MapMixin.V":"@"},"_JsonMapKeyIterable":{"ListIterable":["String"],"EfficientLengthIterable":["String"],"Iterable":["String"],"ListIterable.E":"String","Iterable.E":"String"},"Base64Codec":{"Codec":["List<int>","String"]},"JsonCodec":{"Codec":["Object?","String"]},"DateTime":{"Comparable":["DateTime"]},"double":{"num":[],"Comparable":["num"]},"Duration":{"Comparable":["Duration"]},"int":{"num":[],"Comparable":["num"]},"List":{"EfficientLengthIterable":["1"],"Iterable":["1"]},"num":{"Comparable":["num"]},"Set":{"EfficientLengthIterable":["1"],"Iterable":["1"]},"String":{"Comparable":["String"],"Pattern":[]},"AssertionError":{"Error":[]},"TypeError":{"Error":[]},"ArgumentError":{"Error":[]},"RangeError":{"Error":[]},"IndexError":{"Error":[]},"UnsupportedError":{"Error":[]},"UnimplementedError":{"Error":[]},"StateError":{"Error":[]},"ConcurrentModificationError":{"Error":[]},"OutOfMemoryError":{"Error":[]},"StackOverflowError":{"Error":[]},"_StringStackTrace":{"StackTrace":[]},"StringBuffer":{"StringSink":[]},"_Uri":{"Uri":[]},"_SimpleUri":{"Uri":[]},"_DataUri":{"Uri":[]},"AnchorElement":{"Element":[],"Node":[],"EventTarget":[],"JavaScriptObject":[],"JSObject":[]},"CssRule":{"JavaScriptObject":[],"JSObject":[]},"Element":{"Node":[],"EventTarget":[],"JavaScriptObject":[],"JSObject":[]},"Event":{"JavaScriptObject":[],"JSObject":[]},"File":{"Blob":[],"JavaScriptObject":[],"JSObject":[]},"Gamepad":{"JavaScriptObject":[],"JSObject":[]},"KeyboardEvent":{"Event":[],"JavaScriptObject":[],"JSObject":[]},"LIElement":{"Element":[],"Node":[],"EventTarget":[],"JavaScriptObject":[],"JSObject":[]},"LinkElement":{"Element":[],"Node":[],"EventTarget":[],"JavaScriptObject":[],"JSObject":[]},"MimeType":{"JavaScriptObject":[],"JSObject":[]},"MouseEvent":{"Event":[],"JavaScriptObject":[],"JSObject":[]},"Node":{"EventTarget":[],"JavaScriptObject":[],"JSObject":[]},"Plugin":{"JavaScriptObject":[],"JSObject":[]},"PopStateEvent":{"Event":[],"JavaScriptObject":[],"JSObject":[]},"SourceBuffer":{"EventTarget":[],"JavaScriptObject":[],"JSObject":[]},"SpeechGrammar":{"JavaScriptObject":[],"JSObject":[]},"SpeechRecognitionResult":{"JavaScriptObject":[],"JSObject":[]},"StyleSheet":{"JavaScriptObject":[],"JSObject":[]},"TextTrack":{"EventTarget":[],"JavaScriptObject":[],"JSObject":[]},"TextTrackCue":{"EventTarget":[],"JavaScriptObject":[],"JSObject":[]},"Touch":{"JavaScriptObject":[],"JSObject":[]},"_Html5NodeValidator":{"NodeValidator":[]},"HtmlElement":{"Element":[],"Node":[],"EventTarget":[],"JavaScriptObject":[],"JSObject":[]},"AccessibleNodeList":{"JavaScriptObject":[],"JSObject":[]},"AreaElement":{"Element":[],"Node":[],"EventTarget":[],"JavaScriptObject":[],"JSObject":[]},"BaseElement":{"Element":[],"Node":[],"EventTarget":[],"JavaScriptObject":[],"JSObject":[]},"Blob":{"JavaScriptObject":[],"JSObject":[]},"BodyElement":{"Element":[],"Node":[],"EventTarget":[],"JavaScriptObject":[],"JSObject":[]},"CharacterData":{"Node":[],"EventTarget":[],"JavaScriptObject":[],"JSObject":[]},"CssPerspective":{"JavaScriptObject":[],"JSObject":[]},"CssStyleDeclaration":{"JavaScriptObject":[],"JSObject":[]},"CssStyleValue":{"JavaScriptObject":[],"JSObject":[]},"CssTransformComponent":{"JavaScriptObject":[],"JSObject":[]},"CssTransformValue":{"JavaScriptObject":[],"JSObject":[]},"CssUnparsedValue":{"JavaScriptObject":[],"JSObject":[]},"DataTransferItemList":{"JavaScriptObject":[],"JSObject":[]},"DivElement":{"Element":[],"Node":[],"EventTarget":[],"JavaScriptObject":[],"JSObject":[]},"Document":{"Node":[],"EventTarget":[],"JavaScriptObject":[],"JSObject":[]},"DomException":{"JavaScriptObject":[],"JSObject":[]},"DomImplementation":{"JavaScriptObject":[],"JSObject":[]},"DomRectList":{"ListMixin":["Rectangle<num>"],"ImmutableListMixin":["Rectangle<num>"],"List":["Rectangle<num>"],"JavaScriptIndexingBehavior":["Rectangle<num>"],"JavaScriptObject":[],"EfficientLengthIterable":["Rectangle<num>"],"JSObject":[],"Iterable":["Rectangle<num>"],"ImmutableListMixin.E":"Rectangle<num>","ListMixin.E":"Rectangle<num>"},"DomRectReadOnly":{"JavaScriptObject":[],"Rectangle":["num"],"JSObject":[]},"DomStringList":{"ListMixin":["String"],"ImmutableListMixin":["String"],"List":["String"],"JavaScriptIndexingBehavior":["String"],"JavaScriptObject":[],"EfficientLengthIterable":["String"],"JSObject":[],"Iterable":["String"],"ImmutableListMixin.E":"String","ListMixin.E":"String"},"DomTokenList":{"JavaScriptObject":[],"JSObject":[]},"_ChildrenElementList":{"ListMixin":["Element"],"List":["Element"],"EfficientLengthIterable":["Element"],"Iterable":["Element"],"ListMixin.E":"Element"},"_FrozenElementList":{"ListMixin":["1"],"List":["1"],"EfficientLengthIterable":["1"],"Iterable":["1"],"ListMixin.E":"1"},"EventTarget":{"JavaScriptObject":[],"JSObject":[]},"FileList":{"ListMixin":["File"],"ImmutableListMixin":["File"],"List":["File"],"JavaScriptIndexingBehavior":["File"],"JavaScriptObject":[],"EfficientLengthIterable":["File"],"JSObject":[],"Iterable":["File"],"ImmutableListMixin.E":"File","ListMixin.E":"File"},"FileWriter":{"EventTarget":[],"JavaScriptObject":[],"JSObject":[]},"FormElement":{"Element":[],"Node":[],"EventTarget":[],"JavaScriptObject":[],"JSObject":[]},"History":{"JavaScriptObject":[],"JSObject":[]},"HtmlCollection":{"ListMixin":["Node"],"ImmutableListMixin":["Node"],"List":["Node"],"JavaScriptIndexingBehavior":["Node"],"JavaScriptObject":[],"EfficientLengthIterable":["Node"],"JSObject":[],"Iterable":["Node"],"ImmutableListMixin.E":"Node","ListMixin.E":"Node"},"HtmlDocument":{"Node":[],"EventTarget":[],"JavaScriptObject":[],"JSObject":[]},"ImageData":{"JavaScriptObject":[],"JSObject":[]},"InputElement":{"Element":[],"Node":[],"EventTarget":[],"JavaScriptObject":[],"JSObject":[]},"Location":{"JavaScriptObject":[],"JSObject":[]},"MediaList":{"JavaScriptObject":[],"JSObject":[]},"MessagePort":{"EventTarget":[],"JavaScriptObject":[],"JSObject":[]},"MidiInputMap":{"JavaScriptObject":[],"MapMixin":["String","@"],"JSObject":[],"Map":["String","@"],"MapMixin.K":"String","MapMixin.V":"@"},"MidiOutputMap":{"JavaScriptObject":[],"MapMixin":["String","@"],"JSObject":[],"Map":["String","@"],"MapMixin.K":"String","MapMixin.V":"@"},"MimeTypeArray":{"ListMixin":["MimeType"],"ImmutableListMixin":["MimeType"],"List":["MimeType"],"JavaScriptIndexingBehavior":["MimeType"],"JavaScriptObject":[],"EfficientLengthIterable":["MimeType"],"JSObject":[],"Iterable":["MimeType"],"ImmutableListMixin.E":"MimeType","ListMixin.E":"MimeType"},"_ChildNodeListLazy":{"ListMixin":["Node"],"List":["Node"],"EfficientLengthIterable":["Node"],"Iterable":["Node"],"ListMixin.E":"Node"},"NodeList":{"ListMixin":["Node"],"ImmutableListMixin":["Node"],"List":["Node"],"JavaScriptIndexingBehavior":["Node"],"JavaScriptObject":[],"EfficientLengthIterable":["Node"],"JSObject":[],"Iterable":["Node"],"ImmutableListMixin.E":"Node","ListMixin.E":"Node"},"PluginArray":{"ListMixin":["Plugin"],"ImmutableListMixin":["Plugin"],"List":["Plugin"],"JavaScriptIndexingBehavior":["Plugin"],"JavaScriptObject":[],"EfficientLengthIterable":["Plugin"],"JSObject":[],"Iterable":["Plugin"],"ImmutableListMixin.E":"Plugin","ListMixin.E":"Plugin"},"RtcStatsReport":{"JavaScriptObject":[],"MapMixin":["String","@"],"JSObject":[],"Map":["String","@"],"MapMixin.K":"String","MapMixin.V":"@"},"SelectElement":{"Element":[],"Node":[],"EventTarget":[],"JavaScriptObject":[],"JSObject":[]},"SharedArrayBuffer":{"JavaScriptObject":[],"JSObject":[]},"SourceBufferList":{"ListMixin":["SourceBuffer"],"ImmutableListMixin":["SourceBuffer"],"EventTarget":[],"List":["SourceBuffer"],"JavaScriptIndexingBehavior":["SourceBuffer"],"JavaScriptObject":[],"EfficientLengthIterable":["SourceBuffer"],"JSObject":[],"Iterable":["SourceBuffer"],"ImmutableListMixin.E":"SourceBuffer","ListMixin.E":"SourceBuffer"},"SpanElement":{"Element":[],"Node":[],"EventTarget":[],"JavaScriptObject":[],"JSObject":[]},"SpeechGrammarList":{"ListMixin":["SpeechGrammar"],"ImmutableListMixin":["SpeechGrammar"],"List":["SpeechGrammar"],"JavaScriptIndexingBehavior":["SpeechGrammar"],"JavaScriptObject":[],"EfficientLengthIterable":["SpeechGrammar"],"JSObject":[],"Iterable":["SpeechGrammar"],"ImmutableListMixin.E":"SpeechGrammar","ListMixin.E":"SpeechGrammar"},"Storage":{"JavaScriptObject":[],"MapMixin":["String","String"],"JSObject":[],"Map":["String","String"],"MapMixin.K":"String","MapMixin.V":"String"},"TableElement":{"Element":[],"Node":[],"EventTarget":[],"JavaScriptObject":[],"JSObject":[]},"TableRowElement":{"Element":[],"Node":[],"EventTarget":[],"JavaScriptObject":[],"JSObject":[]},"TableSectionElement":{"Element":[],"Node":[],"EventTarget":[],"JavaScriptObject":[],"JSObject":[]},"TemplateElement":{"Element":[],"Node":[],"EventTarget":[],"JavaScriptObject":[],"JSObject":[]},"TextTrackCueList":{"ListMixin":["TextTrackCue"],"ImmutableListMixin":["TextTrackCue"],"List":["TextTrackCue"],"JavaScriptIndexingBehavior":["TextTrackCue"],"JavaScriptObject":[],"EfficientLengthIterable":["TextTrackCue"],"JSObject":[],"Iterable":["TextTrackCue"],"ImmutableListMixin.E":"TextTrackCue","ListMixin.E":"TextTrackCue"},"TextTrackList":{"ListMixin":["TextTrack"],"ImmutableListMixin":["TextTrack"],"EventTarget":[],"List":["TextTrack"],"JavaScriptIndexingBehavior":["TextTrack"],"JavaScriptObject":[],"EfficientLengthIterable":["TextTrack"],"JSObject":[],"Iterable":["TextTrack"],"ImmutableListMixin.E":"TextTrack","ListMixin.E":"TextTrack"},"TimeRanges":{"JavaScriptObject":[],"JSObject":[]},"TouchList":{"ListMixin":["Touch"],"ImmutableListMixin":["Touch"],"List":["Touch"],"JavaScriptIndexingBehavior":["Touch"],"JavaScriptObject":[],"EfficientLengthIterable":["Touch"],"JSObject":[],"Iterable":["Touch"],"ImmutableListMixin.E":"Touch","ListMixin.E":"Touch"},"TrackDefaultList":{"JavaScriptObject":[],"JSObject":[]},"UIEvent":{"Event":[],"JavaScriptObject":[],"JSObject":[]},"Url":{"JavaScriptObject":[],"JSObject":[]},"VideoTrackList":{"EventTarget":[],"JavaScriptObject":[],"JSObject":[]},"Window":{"EventTarget":[],"JavaScriptObject":[],"JSObject":[]},"_Attr":{"Node":[],"EventTarget":[],"JavaScriptObject":[],"JSObject":[]},"_CssRuleList":{"ListMixin":["CssRule"],"ImmutableListMixin":["CssRule"],"List":["CssRule"],"JavaScriptIndexingBehavior":["CssRule"],"JavaScriptObject":[],"EfficientLengthIterable":["CssRule"],"JSObject":[],"Iterable":["CssRule"],"ImmutableListMixin.E":"CssRule","ListMixin.E":"CssRule"},"_DomRect":{"JavaScriptObject":[],"Rectangle":["num"],"JSObject":[]},"_GamepadList":{"ListMixin":["Gamepad?"],"ImmutableListMixin":["Gamepad?"],"List":["Gamepad?"],"JavaScriptIndexingBehavior":["Gamepad?"],"JavaScriptObject":[],"EfficientLengthIterable":["Gamepad?"],"JSObject":[],"Iterable":["Gamepad?"],"ImmutableListMixin.E":"Gamepad?","ListMixin.E":"Gamepad?"},"_NamedNodeMap":{"ListMixin":["Node"],"ImmutableListMixin":["Node"],"List":["Node"],"JavaScriptIndexingBehavior":["Node"],"JavaScriptObject":[],"EfficientLengthIterable":["Node"],"JSObject":[],"Iterable":["Node"],"ImmutableListMixin.E":"Node","ListMixin.E":"Node"},"_SpeechRecognitionResultList":{"ListMixin":["SpeechRecognitionResult"],"ImmutableListMixin":["SpeechRecognitionResult"],"List":["SpeechRecognitionResult"],"JavaScriptIndexingBehavior":["SpeechRecognitionResult"],"JavaScriptObject":[],"EfficientLengthIterable":["SpeechRecognitionResult"],"JSObject":[],"Iterable":["SpeechRecognitionResult"],"ImmutableListMixin.E":"SpeechRecognitionResult","ListMixin.E":"SpeechRecognitionResult"},"_StyleSheetList":{"ListMixin":["StyleSheet"],"ImmutableListMixin":["StyleSheet"],"List":["StyleSheet"],"JavaScriptIndexingBehavior":["StyleSheet"],"JavaScriptObject":[],"EfficientLengthIterable":["StyleSheet"],"JSObject":[],"Iterable":["StyleSheet"],"ImmutableListMixin.E":"StyleSheet","ListMixin.E":"StyleSheet"},"_AttributeMap":{"MapMixin":["String","String"],"Map":["String","String"]},"_ElementAttributeMap":{"MapMixin":["String","String"],"Map":["String","String"],"MapMixin.K":"String","MapMixin.V":"String"},"_ElementCssClassSet":{"SetMixin":["String"],"Set":["String"],"EfficientLengthIterable":["String"],"Iterable":["String"],"SetMixin.E":"String"},"_EventStream":{"Stream":["1"]},"_ElementEventStreamImpl":{"_EventStream":["1"],"Stream":["1"]},"_EventStreamSubscription":{"StreamSubscription":["1"]},"NodeValidatorBuilder":{"NodeValidator":[]},"_SimpleNodeValidator":{"NodeValidator":[]},"_TemplatingNodeValidator":{"NodeValidator":[]},"_SvgNodeValidator":{"NodeValidator":[]},"FixedSizeListIterator":{"Iterator":["1"]},"_TrustedHtmlTreeSanitizer":{"NodeTreeSanitizer":[]},"_SameOriginUriPolicy":{"UriPolicy":[]},"_ValidatingTreeSanitizer":{"NodeTreeSanitizer":[]},"CssClassSetImpl":{"SetMixin":["String"],"Set":["String"],"EfficientLengthIterable":["String"],"Iterable":["String"]},"FilteredElementList":{"ListMixin":["Element"],"List":["Element"],"EfficientLengthIterable":["Element"],"Iterable":["Element"],"ListMixin.E":"Element"},"Length":{"JavaScriptObject":[],"JSObject":[]},"Number":{"JavaScriptObject":[],"JSObject":[]},"Transform":{"JavaScriptObject":[],"JSObject":[]},"LengthList":{"ListMixin":["Length"],"ImmutableListMixin":["Length"],"List":["Length"],"JavaScriptObject":[],"EfficientLengthIterable":["Length"],"JSObject":[],"Iterable":["Length"],"ImmutableListMixin.E":"Length","ListMixin.E":"Length"},"NumberList":{"ListMixin":["Number"],"ImmutableListMixin":["Number"],"List":["Number"],"JavaScriptObject":[],"EfficientLengthIterable":["Number"],"JSObject":[],"Iterable":["Number"],"ImmutableListMixin.E":"Number","ListMixin.E":"Number"},"PointList":{"JavaScriptObject":[],"JSObject":[]},"ScriptElement0":{"SvgElement":[],"Element":[],"Node":[],"EventTarget":[],"JavaScriptObject":[],"JSObject":[]},"StringList":{"ListMixin":["String"],"ImmutableListMixin":["String"],"List":["String"],"JavaScriptObject":[],"EfficientLengthIterable":["String"],"JSObject":[],"Iterable":["String"],"ImmutableListMixin.E":"String","ListMixin.E":"String"},"AttributeClassSet":{"SetMixin":["String"],"Set":["String"],"EfficientLengthIterable":["String"],"Iterable":["String"],"SetMixin.E":"String"},"SvgElement":{"Element":[],"Node":[],"EventTarget":[],"JavaScriptObject":[],"JSObject":[]},"TransformList":{"ListMixin":["Transform"],"ImmutableListMixin":["Transform"],"List":["Transform"],"JavaScriptObject":[],"EfficientLengthIterable":["Transform"],"JSObject":[],"Iterable":["Transform"],"ImmutableListMixin.E":"Transform","ListMixin.E":"Transform"},"AudioBuffer":{"JavaScriptObject":[],"JSObject":[]},"AudioParamMap":{"JavaScriptObject":[],"MapMixin":["String","@"],"JSObject":[],"Map":["String","@"],"MapMixin.K":"String","MapMixin.V":"@"},"AudioTrackList":{"EventTarget":[],"JavaScriptObject":[],"JSObject":[]},"BaseAudioContext":{"EventTarget":[],"JavaScriptObject":[],"JSObject":[]},"OfflineAudioContext":{"EventTarget":[],"JavaScriptObject":[],"JSObject":[]},"SearchResult":{"Comparable":["SearchResult"]},"IndexParent":{"IndexMember":[]},"IndexLeaf":{"IndexMember":[]},"Int8List":{"List":["int"],"EfficientLengthIterable":["int"],"Iterable":["int"]},"Uint8List":{"List":["int"],"EfficientLengthIterable":["int"],"Iterable":["int"]},"Uint8ClampedList":{"List":["int"],"EfficientLengthIterable":["int"],"Iterable":["int"]},"Int16List":{"List":["int"],"EfficientLengthIterable":["int"],"Iterable":["int"]},"Uint16List":{"List":["int"],"EfficientLengthIterable":["int"],"Iterable":["int"]},"Int32List":{"List":["int"],"EfficientLengthIterable":["int"],"Iterable":["int"]},"Uint32List":{"List":["int"],"EfficientLengthIterable":["int"],"Iterable":["int"]},"Float32List":{"List":["double"],"EfficientLengthIterable":["double"],"Iterable":["double"]},"Float64List":{"List":["double"],"EfficientLengthIterable":["double"],"Iterable":["double"]}}'));
  A._Universe_addErasedTypes(init.typeUniverse, JSON.parse('{"__CastListBase__CastIterableBase_ListMixin":2,"NativeTypedArray":1,"IterableBase":1,"ListBase":1,"MapBase":2,"SetBase":1,"_SetBase":1,"_ListBase_Object_ListMixin":1,"_SetBase_Object_SetMixin":1,"__SetBase_Object_SetMixin":1,"__UnmodifiableSet__SetBase__UnmodifiableSetMixin":1,"Converter":2}'));
  var string$ = {
  ...
  var type$ = (function rtii() {
    ...
    return {
      ...
      IndexMember: findType("IndexMember"),
      ...
      JSArray_IndexMember: findType("JSArray<IndexMember>"),
      ...
      List_IndexMember: findType("List<IndexMember>"),
      List_SearchResult: findType("List<SearchResult>"),
      ...
      SearchResult: findType("SearchResult"),
      SearchResults: findType("SearchResults"),
...
;
    ...
    B.List_43h = A._setArrayType(makeConstList(["00000", "0000", "000", "00", "0", ""]), type$.JSArray_String);
    ...
    B.List_empty0 = A._setArrayType(makeConstList([]), type$.JSArray_IndexMember);
    ...
    B.List_Jkt = A._setArrayType(makeConstList(["dart:cli", "dart:html", "dart:svg"]), type$.JSArray_String);
    B.Map_JkYYn = new A.ConstantStringMap(3, {"dart:cli": null, "dart:html": null, "dart:svg": null}, B.List_Jkt, type$.ConstantStringMap_String_Null);
    B.Set_FMav3 = new A._UnmodifiableSet(B.Map_JkYYn, type$._UnmodifiableSet_String);
    B.List_flutter = A._setArrayType(makeConstList(["flutter"]), type$.JSArray_String);
    B.Map_6pad8 = new A.ConstantStringMap(1, {flutter: null}, B.List_flutter, type$.ConstantStringMap_String_Null);
    B.Set_uTEps = new A._UnmodifiableSet(B.Map_6pad8, type$._UnmodifiableSet_String);
